...
import ekkel_reflection.ex11pets.TypeCounter;
...
class AirFilter extends Filter{
    static class Factory implements ekkel_reflection.ex13factories.Factory<AirFilter> {
...
class FuelFilter extends Filter {
    static class Factory implements ekkel_reflection.ex13factories.Factory<FuelFilter> {
        @Override
...
class FuelEngine extends Engine {
    static class Factory implements ekkel_reflection.ex13factories.Factory<FuelEngine> {
        @Override
...
class DieselEngine extends Engine {
    static class Factory implements ekkel_reflection.ex13factories.Factory<DieselEngine> {
        @Override
